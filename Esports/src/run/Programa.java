    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (op == 1) {
                ...
                sc.nextLine();
                Categoria cat = null;
                for (Categoria c : s.categorias) {
                    if (c.getId() == id) {
                        cat = c;
                    }
                }
                if (cat != null) {
                    s.juegos.add(new Juego(n, cat));
                }
            } else if (op == 3) {
                ...
                if (t != null) {
                    ...
                    System.out.print("ID equipo A: ");
                    long ida = sc.nextLong();
                    sc.nextLine();
                    System.out.print("ID equipo B: ");
                    long idb = sc.nextLong();
                    sc.nextLine();
                    Equipo ea = null, eb = null;
                    ...
                    long idj = sc.nextLong();
                    sc.nextLine();
                    Juego j = null;
                    for (Juego jj : s.juegos) {
                        if (jj.getId() == idj) {
                            j = jj;
                        }
                    }
                    System.out.println("Arbitros: " + s.arbitros);
                    System.out.print("ID arbitro: ");
                    long ida2 = sc.nextLong();
                    sc.nextLine();
                    Arbitro ar = null;
                    for (Arbitro a : s.arbitros) {
                        if (a.getId() == ida2) {
                            ar = a;
                        }
                    }
                    if (ea != null && eb != null && j != null && ar != null) {
                        t.crearPartida(ea, eb, j, ar);
                    }
                }
            } else if (op == 8) {
                ...
                if (borrar != null) {
                    s.jugadores.remove(borrar);
                    for (Equipo e : s.equipos) {
                        e.removeJugador(borrar);
                ...
                if (borrar != null) {
                    s.equipos.remove(borrar);
                    for (Torneo t : s.torneos) {
                        t.removeEquipo(borrar);
                ...
                if (borrar != null) {
                    borrar.eliminarTodasPartidas();
                    s.torneos.remove(borrar);
                }
            } else if (op == 11) {
                s.imprimirEstado();
            } else {
